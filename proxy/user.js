...
exports.getUsersByGroupId = function (groupid, callback){
    Group.findById(groupid,function(err, group){
        if(err)
            return callback(err);
        
        User.find({'_id': {'$in': group.users}}, callback);
    });
};
...
exports.setDefaultAvatar = function(callback){

    User.find({},function(err, users){
        console.log('start reset avatar:'+users.length);
